.PHONY: demo-stage-1 demo-stage-4 demo-admin verify-real-storage verify-real-provider verify-real-rag-answer benchmark-local
...
verify-real-rag-answer:
	powershell -NoProfile -ExecutionPolicy Bypass -File scripts/verify-real-rag-answer.ps1
